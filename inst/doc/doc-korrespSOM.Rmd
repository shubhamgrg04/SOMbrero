...
either "r" or "c" (here, as an example, "Megret" which is the first candidate):
```{r presiProtoNumber, fig.width=12, fig.height=6}
par(mfrow=c(1,2))
plot(korresp.som, what="prototypes", type="color", variable=1, view="c")
plot(korresp.som, what="prototypes", type="3d", variable=1, view="c")
```
Hence "Megret" has a position similar to that of "Le Pen" on the map which
illustrates the fact that he is also a far-right candidate.
